...
pub struct ImGuiIO {
    ...
    pub key_map: [::std::os::raw::c_int; 645usize],
    pub keys_down: [bool; 645usize],
    pub mouse_pos: [f32; 2],
    pub mouse_down: [bool; 5usize],
    pub mouse_wheel: f32,
    ...
    pub ket_alt: bool,
    pub key_super: bool,
    pub nav_inputs: [f32; 21usize],
    pub key_mods: ImGuiModFlags,
    pub keys_data: [ImGuiKeyData; 645usize],
    pub WantCaptureMouseUnlessPopupClose: bool,
    pub MousePosPrev: [f32; 2],
    pub MouseClickedPos: [[f32; 2]; 5usize],
...
pub struct ImGuiWindowTempData {
    ...
    pub CursorStartPosLossyness: [f32; 2],
...
extern "C" {
    pub fn ImVec4_ImVec4_Nil() -> *mut [f32; 4];
}
extern "C" {
    pub fn ImVec4_destroy(self_: *mut [f32; 4]);
}
extern "C" {
    pub fn ImVec4_ImVec4_Float(_x: f32, _y: f32, _z: f32, _w: f32) -> *mut [f32; 4];
}
extern "C" {
...
extern "C" {
    pub fn igImFloorSigned_Vec2(pOut: *mut [f32; 2], v: [f32; 2]);
}
extern "C" {
