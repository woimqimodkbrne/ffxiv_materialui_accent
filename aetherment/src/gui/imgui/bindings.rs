...
pub struct ImGuiStyle {
    pub alpha: f32,
    // pub disabledAlpha: f32, // for some reason theres 1 too many shifting all the others down by 4 bytes
    ...
    pub color_button_position: ImGuiDir,
